...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
            <div id="content">
                <p class="text-center font-weight-bold" style="font-size: 50px;">CATATAN PENGELUARAN</p>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a class="btn btn-primary" href="controller/pengeluaran/tambah-pengeluaran.php">Tambah Pengeluaran</a>
                                    <br>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="controller/pengeluaran/edit-pengeluaran.php?id=<?php echo $row['id_pengeluaran'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                                                    <a href="controller/pengeluaran/hapus-pengeluaran.php?id=<?php echo $row['id_pengeluaran'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
