...
$query = "SELECT * FROM pengeluaran WHERE id_pengeluaran = $id LIMIT 1";
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="update-pengeluaran.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id_pengeluaran" value="<?php echo htmlspecialchars($row['id_pengeluaran']); ?>">
                            </div>
